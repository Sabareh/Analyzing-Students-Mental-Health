# Analyzing-Students-Mental-Helath
...
In this project  explore the `students` data using PostgreSQL to find out if I would come to a similar conclusion for international students and see if the length of stay is a contributing factor.
